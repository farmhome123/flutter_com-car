                          ...
                          child: Container(
                            child: IconButton(
                              ...
                              onPressed: () async {
                                ...
                                //             .toLowerCase()) {
                                //       print(
                                //           '############# _characteristic!.uuid True ##############');
                                //       characteristic!
                                //           .write(utf8.encode('REQ#'));
                                //     } else {
                                //       print(
                                //           '############# _characteristic!.uuid False ##############');
                                //     }
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: RichText(
                              ...
                              TextSpan(
                                  text:
                                      '   ${context.watch<valueProvider>().frp}   ',
                                  style: GoogleFonts.sriracha(
                                      color: Colors.blue,
                                      fontSize: 20,
                                      fontWeight: FontWeight.bold)),
                          ...
                          Padding(
                            ...
                            child: RichText(
                              ...
                              TextSpan(
                                  text:
                                      '   ${context.watch<valueProvider>().vfrp}  ',
                                  style: GoogleFonts.sriracha(
                                      color: Colors.blue,
                                      fontSize: 20,
                                      fontWeight: FontWeight.bold)),
